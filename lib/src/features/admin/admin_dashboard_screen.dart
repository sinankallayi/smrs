        ...
        data: (roles) {
          return sectionsAsync.when(
            data: (sections) {
              ...
              // Exclude SuperAdmin, Management, Staff, SectionHead, AND HR
              // Shows ONLY roles defined in the Controller (plus 'manager' if added there)
                    ...
                    onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => UserManagementScreen(
                          title: 'HR Management',
                          allowedRoles: const [AppRoles.hr],
                        ),
                      ),
                    ),
                  ),
